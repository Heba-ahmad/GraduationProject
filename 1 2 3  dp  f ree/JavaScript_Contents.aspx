<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="JavaScript_Contents.aspx.cs" Inherits="_Default" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<A title="SignUp" 
  href="Signup.aspx">Signup</A>                                
    ...
    <asp:Login ID="Login1" runat="server" Font-Bold="False" Font-Overline="False" 
        ...
        DestinationPageUrl="~/JavaScript_Contents.aspx" DisplayRememberMe="False" Font-Names="Calibri" 
          ...
          <hr />
            <DIV align=center 
                ...
                &nbsp;&nbsp;<img alt="" src="images/JAVASCRIPT.PNG" 
                    style="width: 204px; height: 78px" /><br />
                &nbsp;
                                            <asp:LinkButton ID="LinkButton5" runat="server" ForeColor="#3DAAFE" 
                                                PostBackUrl="~/JavaScript.aspx">&lt;&lt; Previous</asp:LinkButton>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton ID="LinkButton7" runat="server" BorderStyle="None" 
                    ...
                    PostBackUrl="~/Programming_Tutorials.aspx">Back to Programming Tutorials!</asp:LinkButton>
                                            ...
                                            <asp:LinkButton ID="LinkButton6" runat="server" ForeColor="#3DAAFE" 
                                                PostBackUrl="~/JavaScript_L1.aspx">Next &gt;&gt;</asp:LinkButton>
                                            <br />
                                            <br />
              </DIV>
        </DIV>
        <DIV align=center>
        <H2>JavaScript Tutorial Content         <BR></DIV>
      <DIV class=para1>
      <TABLE border=0 cellSpacing=0 cellPadding=10 width="90%" align="right">
        <TBODY>
        <TR>
          <TD>
<DIV class=para2 align="left"><A href="JavaScript_L1.aspx">
<H4>Lesson 1</H4></A>
<UL>
  <LI>WHERE TO PLACE IT  
  <LI>THE FIRST SCRIPT
  <LI>CAPITAL LETTERS
  <LI>POPUP BOXES
  <LI>VARIABLES
...
href="JavaScript_L2.aspx">
<H4>Lesson 2</H4></A>
<UL>
  <LI>BROWSER DETECTION & ANIMATED BUTTONS
  <LI>TECHNIQUE 
  <LI>THE CODE
  <LI>EXAMPLE
  <LI>DETECT TOOL
  </LI></UL><A 
href="JavaScript_L3.aspx">
<H4>Lesson 3</H4></A>
<UL>
  <LI>COOKIES & DROP DOWN MENU
  <LI>TECHNIQUE 
  <LI>THE CODE
  <LI>EXAMPLE
  <LI>DETECT TOOL
...
href="JavaScript_L4.aspx">
<H4>Lesson 4</H4></A>
<UL>
  <LI>FORM VALIDATION & MULTIPLE LINK 
   <LI>TECHNIQUE 
  <LI>THE CODE
  <LI>EXAMPLE
  </LI></UL><A 
href="JavaScript_L5.aspx">
<H4>Lesson 5</H4></A>
<UL>
  <LI>FRAMESET SCRIPT
  <LI>TECHNIQUE 
  <LI>THE CODE
  <LI>EXAMPLE
  </LI></UL><A href="JavaScript_L6.aspx">
  <H4>Lesson 6</H4></A>
<UL>
  <LI>POPUP WINDOWS 
  <LI>TECHNIQUE 
