<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="W-G-Designing_Tutorials.aspx.cs" Inherits="_Default" %>
...
href="images/Tutorials_Contents_style.css" media=screen><LINK 
...
<DIV id=title>
  ...
  <!-- Portfolio -->
					<div class="post" id="portfolio">
						<h2 style="font-size: 21px; color: #178ACD;">Designing Tutorials Menu</h2>
						<div class="portfolio" align="right">
							<div class="portfolio-holder">
								<ul>
								       <li>
								    	<a href="DreamWeaver.aspx" target="_self" title="">
                                        <img src="images/Dreamweaver.JPG"" /></a>
								    	<a href="#" target="_self" title="">
                                        <img src="images/3DMAX.JPG" /></a>
								    </li>
								    <li>
								    	<a href="CSS.aspx" target="_self" title="">
                                        <img src="images/CSS.jpg" /></a>
								    	<a href="#" target="_self" title="">
                                        <img src="images/Photoshop.JPG" /></a>
								    </li>
								    <li>
								    	<a href="HTML.aspx" target="_self" title="">
                                        <img src="images/html.jpg" /></a>
								    	<a href="#" target="_self" title="">
                                        <img src="images/Maya.JPG" /></a>
								    </li>
								    <li>&nbsp;</li>
								</ul>
							</div>
							<div class="portfolio-nav">
								<a href="#" class="prev" 
                                    style="background-image: url('images/portfolio-button.png')">Previous</a>
								<a href="#" class="next" 
                                    style="background-image: url('images/portfolio-button.png')">Next</a>
							</div>
						</div>
					</div>
					<!-- End Portfolio -->                                              
...
href="Tutorials_MainPage.aspx" rel=bookmark style="color: #0A98E4">Back to the Tutorials Page ^_^</A></H3><SPAN 
class=date>>></SPAN>&nbsp;<SPAN class=author><a href="Default.aspx">Home 
Page</a></SPAN><BR></DIV><!--end title--><!--start content-->
    <!--end content--><!--start vavigation-->
    <!--end navigation--></DIV></DIV></DIV></DIV></DIV></DIV>
<DIV id=right_column>
<DIV id=statusbar>
...
<H2>Login</H2>
<UL>
  <LI>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<span>&nbsp; </span> &nbsp;<A title="Login" 
  href="Login.aspx">Login</A>&nbsp;&nbsp;&nbsp; l&nbsp;&nbsp; <A title="SignUp" 
