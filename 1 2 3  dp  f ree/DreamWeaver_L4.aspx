<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="DreamWeaver_L4.aspx.cs" Inherits="_Default" %>
...
<TABLE border=0 width="100%">
  ...
  href="Signup.aspx">Signup</A> <SPAN class=author>to add comment, &amp; to Rate The Tutorials 
    ...
    <asp:Login ID="Login1" runat="server" Font-Bold="False" Font-Overline="False" 
        ...
        DestinationPageUrl="~/DreamWeaver_L4.aspx" DisplayRememberMe="False" Font-Names="Calibri" 
            ...
            <DIV align=center 
                ...
                &nbsp;
                                            <asp:LinkButton ID="LinkButton5" runat="server" ForeColor="#3DAAFE" 
                                                PostBackUrl="~/DreamWeaver_L3.aspx">&lt;&lt; 
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton ID="LinkButton7" runat="server" BorderStyle="None" 
                    ...
                    PostBackUrl="~/DreamWeaver_Contents.aspx">Back to DreamWeaver Contents!</asp:LinkButton>
                                            ...
                                            <asp:LinkButton ID="LinkButton6" runat="server" ForeColor="#3DAAFE" 
                                                PostBackUrl="DreamWeaver_L5.aspx">Next &gt;&gt;</asp:LinkButton>
                                            <br />
                                            <br />
              </DIV>
        </DIV>
        <DIV align=center>
        <H2>LESSON 4 -  Basic Features </H2>
            <BR>
                        </DIV>
      <DIV class=para1>
      <TABLE border=0 cellSpacing=0 cellPadding=10 width="90%" align="left">
        ...
        stuff to the people at M.I.T.<BR>
                                                        ...
                                                        <blockquote>
                                                            <div align="center">
                                                                <img alt="" src="images/LessonsImages/DREAMWEAVERLessons/2c1[1]..GIF" 
                                                                    style="width: 488px; height: 158px" /></div>
                                                        </blockquote>
                                                        <p>
            ...
            <DIV align=center style="background-image: url('images/tabletop_gradient.gif')">
                &nbsp;&nbsp;&nbsp;
                                            <asp:LinkButton ID="LinkButton3" runat="server" ForeColor="#3DAAFE" 
                                                PostBackUrl="~/DreamWeaver_L3.aspx">&lt;&lt; Previous</asp:LinkButton>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
